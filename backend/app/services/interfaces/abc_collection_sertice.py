...
from app.schemas.dto import CollectionCategoryDTO, CollectionDTO, CollectionProductLimitDTO, CollectionWithDetailsDTO, ProductWithCategoriesDTO
...
class ICollectionService(Protocol):
    ...
    async def collections_by_cat_id(self, cat_id: int) -> list[CollectionWithDetailsDTO]: ...
