...
class IBaseUOW(Protocol):
    def __init__(self):
        ...
        self.__collection_product_limit_repo: ICollectionProductLimitRepository | None = None
    ...
    @property
    def collection_product_limit_repo(self) -> ICollectionProductLimitRepository: ...
